...
export default {
  ...
  knowledge: {
    ...
    new: {
      ...
      desc: 'Pick one or more files to ingest. Parsing and embedding run in the background; ready documents show up on the main page.',
      descText: 'Paste or type content to skip file parsing and go straight to chunking and embedding — usually done in seconds.',
      tabFile: 'File import',
      tabText: 'Write text',
      note: 'Up to {max} files at a time, each under {size} MB and {total} MB in total. You can close this window — processing continues in the background.',
    },
    tasks: {
      title: 'This upload',
      clear: 'Clear list',
    ...
    upload: {
      ...
      titlePlaceholderBatch: 'No shared title for a batch — each file uses its own content heading',
      submit: 'Ingest',
      submitting: 'Ingesting…',
      failed: 'Processing failed — see the reason under “Upload records”',
      success: 'Ingested “{title}” — {chunks} chunks.',
      batchAccepted: '{accepted} file(s) queued; processing continues in the background.',
      batchQueued: '{accepted} queued, {rejected} not queued (see the list for reasons).',
      allRejected: 'None of these files were queued — see the reasons in the list.',
      selectedSummary: '{count} selected, {size} total',
      ...
      tooMany: 'You can select at most {limit} files at a time.',
      batchTooLarge: 'These files exceed the {limit} MB total limit.',
