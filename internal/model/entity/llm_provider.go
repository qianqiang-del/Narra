...
type LLMProvider struct {
	...
	Protocol        string          `gorm:"column:protocol;type:varchar(32);not null;default:openai-compatible" json:"protocol"`
	...
	TimeoutSeconds  int32           `gorm:"column:timeout_seconds;not null;default:60" json:"timeout_seconds"`
	Models          json.RawMessage `gorm:"column:models;type:jsonb;not null;default:'[]'" json:"models"`
	TestStatus      string          `gorm:"column:test_status;type:varchar(20);not null;default:untested" json:"test_status"`
